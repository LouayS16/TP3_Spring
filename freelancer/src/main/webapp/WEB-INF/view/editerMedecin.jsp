...
<form action="updateMedecin" method="post">
 ...
 <input type="text" name="idMedecin" value="${Medecin.idMedecin}" readonly class="form-control"/>
 </div>
 <div class="form-group">
...
class="form-control"/>
 ...
 <div class="form-group">
 <label class="control-label">Salaire Medecin :</label>
 <input type="text" name="Salaire" value="${Medecin.Salaire}"
class="form-control"/>
 </div> 
 <div class="form-group">
...
var="formatDate" />
 <input type="date" name="datenaissance" value="${formatDate}" class="form-control"/>
</div>
 <div>
